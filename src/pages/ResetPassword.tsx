/*
  Arquivo: planeja-dash-rebuild-main/src/pages/ResetPassword.tsx
...
// Declara o componente/funcão 'ResetPassword' como arrow function. É uma forma comum de definir componentes funcionais em React.
const ResetPassword = () => {
