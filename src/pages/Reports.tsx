/*
  Arquivo: planeja-dash-rebuild-main/src/pages/Reports.tsx
...
// Declara o componente/funcão 'handleCardClick' como arrow function. É uma forma comum de definir componentes funcionais em React.
  const handleCardClick = (cardType: string) => {
    setExpandedCard(expandedCard === cardType ? null : cardType);
  };

// Declara o componente/funcão 'handleTaskCategoryClick' como arrow function. É uma forma comum de definir componentes funcionais em React.
  const handleTaskCategoryClick = (category: string) => {
    setSelectedTaskCategory(category);
  };

// Declara o componente/funcão 'handleProjectClick' como arrow function. É uma forma comum de definir componentes funcionais em React.
  const handleProjectClick = (projectName: string) => {
    setSelectedProject(projectName);
  };

// Declara o componente/funcão 'handleTeamMemberClick' como arrow function. É uma forma comum de definir componentes funcionais em React.
  const handleTeamMemberClick = (memberName: string) => {
    setSelectedTeamMember(memberName);
  };

// Declara o componente/funcão 'handleExport' como arrow function. É uma forma comum de definir componentes funcionais em React.
...
// Declara o componente/funcão 'resetFilters' como arrow function. É uma forma comum de definir componentes funcionais em React.
  const resetFilters = () => {
    setPeriod("month");
    setScope("all");
    setGranularity("day");
