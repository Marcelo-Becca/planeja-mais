/*
  Arquivo: planeja-dash-rebuild-main/src/components/ui/sidebar.tsx
...
// Define a função/componente 'useSidebar'. Componentes em React são funções que retornam JSX.
function useSidebar() {
...
// useEffect: executa efeitos colaterais (chamadas API, timers). O array de dependências determina quando ele roda.
  React.useEffect(() => {
// Declara o componente/funcão 'handleKeyDown' como arrow function. É uma forma comum de definir componentes funcionais em React.
