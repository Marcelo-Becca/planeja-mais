/*
  Arquivo: planeja-dash-rebuild-main/src/components/ui/menubar.tsx
...
// Declara o componente/funcão 'MenubarShortcut' como arrow function. É uma forma comum de definir componentes funcionais em React.
