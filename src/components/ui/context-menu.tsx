/*
  Arquivo: planeja-dash-rebuild-main/src/components/ui/context-menu.tsx
...
// Declara o componente/funcão 'ContextMenuShortcut' como arrow function. É uma forma comum de definir componentes funcionais em React.
