/*
  Arquivo: planeja-dash-rebuild-main/src/components/Sidebar.tsx
...
// Declara o componente/funcão 'getActiveItem' como arrow function. É uma forma comum de definir componentes funcionais em React.
  const getActiveItem = () => {
...
// useEffect: executa efeitos colaterais (chamadas API, timers). O array de dependências determina quando ele roda.
  useEffect(() => {
// Declara o componente/funcão 'handleResize' como arrow function. É uma forma comum de definir componentes funcionais em React.
    const handleResize = () => {
