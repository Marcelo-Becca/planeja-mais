/*
  Arquivo: planeja-dash-rebuild-main/src/components/CreateTaskModal.tsx
...
// Declara o componente/funcão 'validateForm' como arrow function. É uma forma comum de definir componentes funcionais em React.
  const validateForm = () => {
...
// Declara o componente/funcão 'handleCancel' como arrow function. É uma forma comum de definir componentes funcionais em React.
  const handleCancel = () => {
...
// Declara o componente/funcão 'addSubtask' como arrow function. É uma forma comum de definir componentes funcionais em React.
  const addSubtask = () => {
    if (newSubtask.trim()) {
      setFormData(prev => ({
        ...prev,
...
// Declara o componente/funcão 'removeSubtask' como arrow function. É uma forma comum de definir componentes funcionais em React.
...
// Declara o componente/funcão 'toggleAssignee' como arrow function. É uma forma comum de definir componentes funcionais em React.
...
// Declara o componente/funcão 'handleFileUpload' como arrow function. É uma forma comum de definir componentes funcionais em React.
...
// Declara o componente/funcão 'removeAttachment' como arrow function. É uma forma comum de definir componentes funcionais em React.
...
// Declara o componente/funcão 'getSelectedProject' como arrow function. É uma forma comum de definir componentes funcionais em React.
  const getSelectedProject = () => {
    return mockProjects.find(p => p.id === formData.projectId);
  };

// Declara o componente/funcão 'getSelectedMembers' como arrow function. É uma forma comum de definir componentes funcionais em React.
