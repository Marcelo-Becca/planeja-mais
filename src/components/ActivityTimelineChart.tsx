/*
  Arquivo: planeja-dash-rebuild-main/src/components/ActivityTimelineChart.tsx
...
// Declara o componente/funcão 'formatXAxisLabel' como arrow function. É uma forma comum de definir componentes funcionais em React.
