/*
  Arquivo: planeja-dash-rebuild-main/src/components/TeamCard.tsx
...
// Declara o componente/funcão 'getTeamColorClass' como arrow function. É uma forma comum de definir componentes funcionais em React.
